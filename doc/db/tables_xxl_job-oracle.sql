...
-- ##      - Data types mapped to Oracle equivalents (NUMBER, VARCHAR2, CLOB, TIMESTAMP). ##
-- ##      - AUTO_INCREMENT replaced with GENERATED BY DEFAULT AS IDENTITY.          ##
-- ##      - Comments are added using COMMENT ON statements.                         ##
-- ##      - MySQL-specific syntax has been removed.                                   ##
-- ##                                                                                ##
-- ####################################################################################
